# 1 "C:\\Users\\LENOVO\\OneDrive\\Escritorio\\TP_Tópicos_2025_2c_jueves_LOS_FUNDAMENTALISTAS_DE_LINUX\\comunes.c"
...
# 8 "C:\\Users\\LENOVO\\OneDrive\\Escritorio\\TP_Tópicos_2025_2c_jueves_LOS_FUNDAMENTALISTAS_DE_LINUX\\comunes.c" 2
...
int validarFechaForm(char* ans)
{
    ...
    if(ans[4] != '-'){
        printf("\x1b[1m" "\x1b[1;31m" "Error: delimitador incorrecto, vuelva a intenta\n" "\x1b[0m");
        return 0;
    }
    ...
    if(tmp < 0 || tmp > 12){
        printf("\x1b[1m" "\x1b[1;31m" "Error: mes incorrecto, vuelva a intentar\n" "\x1b[0m");
        return 0;
    }
    ...
    if(tmp < 201612 || tmp > 202507){
        printf("\x1b[1m" "\x1b[1;31m" "Error: fecha fuera de rango [2016-12 ; 2025-07], vuelva a intentar\n" "\x1b[0m");
        return 0;
    }
...
void imprimirHeaderTabla(char* titulo, char** campos, int* paddings, int cc)
{
    ...
    printf("\x1b[1m" "\x1b[1;32m" "%s\n", titulo);
    printf("\x1b[0;37m" "%-*s\t | ", paddings[0], campos[0]);
...
void mostrarDivisiones(void* reg)
{
    ...
    fprintf(
# 74 "C:\\Users\\LENOVO\\OneDrive\\Escritorio\\TP_Tópicos_2025_2c_jueves_LOS_FUNDAMENTALISTAS_DE_LINUX\\comunes.c" 3
           (__acrt_iob_func(1))
# 74 "C:\\Users\\LENOVO\\OneDrive\\Escritorio\\TP_Tópicos_2025_2c_jueves_LOS_FUNDAMENTALISTAS_DE_LINUX\\comunes.c"
                 , "\x1b[1m" "\x1b[1;36m" "%s" "\x1b[0;37m" "|"
            "\x1b[1;33m" "%s" "\x1b[0;37m" "|" "\x1b[1;32m" "%s"
            "\x1b[0;37m" "|" "\x1b[1;31m" "%s" "\x1b[0;37m" "|" "\x1b[1;36m" "%s"
            "\x1b[0;37m" "|" "\x1b[1;33m" "%s" "\x1b[0;37m" "|" "\x1b[1;32m" "%s" "\x1b[0;37m" "|" "\x1b[1;31m"
            "%s" "\x1b[0m" "\n", tmp->cod, tmp->desc, tmp->clasif, tmp->indiceIPC, tmp->varMensIPC, tmp->varAnualIPC, tmp->region, tmp->periodo);
    waitJ++;
}
...
void mostrarAperturas(void* reg)
{
    ...
    fprintf(
# 109 "C:\\Users\\LENOVO\\OneDrive\\Escritorio\\TP_Tópicos_2025_2c_jueves_LOS_FUNDAMENTALISTAS_DE_LINUX\\comunes.c" 3
           (__acrt_iob_func(1))
# 109 "C:\\Users\\LENOVO\\OneDrive\\Escritorio\\TP_Tópicos_2025_2c_jueves_LOS_FUNDAMENTALISTAS_DE_LINUX\\comunes.c"
                 , "\x1b[1m" "\x1b[1;36m" "%s" "\x1b[0;37m" "|"
            "\x1b[1;33m" "%s" "\x1b[0;37m" "|" "\x1b[1;32m" "%s"
            "\x1b[0;37m" "|" "\x1b[1;31m" "%s" "\x1b[0;37m" "|" "\x1b[1;36m" "%s"
            "\x1b[0;37m" "|" "\x1b[1;33m" "%s" "\x1b[0;37m" "|" "\x1b[1;32m" "%s" "\x1b[0;37m" "|" "\x1b[1;31m"
