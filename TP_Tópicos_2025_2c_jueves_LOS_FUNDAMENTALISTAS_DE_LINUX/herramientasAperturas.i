# 1 "C:\\Users\\LENOVO\\OneDrive\\Escritorio\\TP_Tópicos_2025_2c_jueves_LOS_FUNDAMENTALISTAS_DE_LINUX\\herramientasAperturas.c"
...
# 1 "C:\\Users\\LENOVO\\OneDrive\\Escritorio\\TP_Tópicos_2025_2c_jueves_LOS_FUNDAMENTALISTAS_DE_LINUX\\herramientasAperturas.h" 1
# 10 "C:\\Users\\LENOVO\\OneDrive\\Escritorio\\TP_Tópicos_2025_2c_jueves_LOS_FUNDAMENTALISTAS_DE_LINUX\\herramientasAperturas.h"
...
# 11 "C:\\Users\\LENOVO\\OneDrive\\Escritorio\\TP_Tópicos_2025_2c_jueves_LOS_FUNDAMENTALISTAS_DE_LINUX\\herramientasAperturas.h" 2
...
# 12 "C:\\Users\\LENOVO\\OneDrive\\Escritorio\\TP_Tópicos_2025_2c_jueves_LOS_FUNDAMENTALISTAS_DE_LINUX\\herramientasAperturas.h" 2
...
# 15 "C:\\Users\\LENOVO\\OneDrive\\Escritorio\\TP_Tópicos_2025_2c_jueves_LOS_FUNDAMENTALISTAS_DE_LINUX\\herramientasAperturas.h" 2
...
# 8 "C:\\Users\\LENOVO\\OneDrive\\Escritorio\\TP_Tópicos_2025_2c_jueves_LOS_FUNDAMENTALISTAS_DE_LINUX\\herramientasAperturas.c" 2
...
int herramientaCalcularAlquilerIPCAperturas(Vector_t* aper)
{
    ...
    stringNCopy(region, tmp.region, 15);
    ...
    puts("\x1b[2J\x1b[H");
    printf("El alquiler original de " "\x1b[1m\x1b[1;36m" "$%s" "\x1b[0m" " a la fecha " "\x1b[1m\x1b[1;36m" "%s" "\x1b[0m"
            " en la region " "\x1b[1m\x1b[1;36m" "%s" "\x1b[0m" ", ha variado en un " "\x1b[1m\x1b[1;33m" "%%%s" "\x1b[0m"
            " hacia un total ajustado de " "\x1b[1m\x1b[1;33m" "$%s" "\x1b[0m" " al periodo " "\x1b[1m\x1b[1;36m" "%s" "\x1b[0m" "\n",
            tmp.monto, tmp.periodo, region, tmpAlq->acumuladoIPC, tmpAlq->montoAjustado, tmpAlq->periodo);

    esperarInput();

    puts("\x1b[2J\x1b[H");
    printf("\x1b[1m" "%-*s\t" " | " "%-*s\t" " | " "%-*s\t" " | " "%-*s" "\x1b[0m" "\n", 30, "Periodo", 18, "Indice", 18, "Variacion%", 18, "Monto ajustado");
    ...
    vectorEscribirABinario(alquileres, "./archivos/pruebaAlquileres.dat");
    vectorLeerDeBinario(alquileres, "./archivos/pruebaAlquileres.dat");

    puts("\x1b[2J\x1b[H");
    printf("\x1b[1m" "Contenidos del archivo binario\n" "\x1b[0m");
    printf("\x1b[1m" "%-*s\t" " | " "%-*s\t" " | " "%-*s\t" " | " "%-*s" "\x1b[0m" "\n", 30, "Periodo", 18, "Indice", 18, "Variacion%", 18, "Monto ajustado");
    puts("\x1b[1m\x1b[1;37m" "-------------------------------------------------------------------------------------------------" "\x1b[0m");
    mostrarVector(alquileres, mostrarAlquileres);
...
RespuestaAlquileres preguntarAlquileres(void)
{
    ...
    Formulario_t f;
    char* regiones[15] = {"Nacional", "GBA", "Pampeana", "Cuyo", "Noroeste", "Noreste", "Patagonia"};

    formularioInit(&f, "Calcular alquileres por inflacion");

    formularioAgregarCampoVA(&f, "Ingrese monto del alquiler ($)", 1, 0, 0.0f, 9999999.9f);
    formularioAgregarCampoVA(&f, "Seleccione region de analisis", 1, 2, 6, regiones);
    formularioAgregarCampoVA(&f, "Ingrese periodo de inicio del contrato (AAAA-MM)", 1, 1, 30, validarFechaForm, convertirFechaResAper);

    formularioPublicar(&f);

    stringNCopy(ans.monto, formularioRespuesta(&f, 0), 18);
    stringNCopy(ans.region, formularioRespuesta(&f, 1), 15);
    stringNCopy(ans.periodo, formularioRespuesta(&f, 2), 30);
...
void* mapearAlquileres(void* dato, void* tmp, void* contexto)
{
    ...
    stringNCopy(tmpT->periodo, tmpD->periodo, 30);
    stringNCopy(tmpT->indiceIPC, tmpD->indiceIPC, 18);
...
void mostrarAlquileres(void* elem)
{
    ...
    printf("\x1b[1m" "\x1b[1;36m" "%-*s\t" "\x1b[0;37m" " | " "\x1b[1;36m" "%-*s\t" "\x1b[0;37m" " | " "\x1b[1;36m" "%-*s\t" "\x1b[0;37m" " | " "\x1b[1;36m" "%-*s\n" "\x1b[0m", 30, tmp->periodo, 18, tmp->indiceIPC, 18, tmp->acumuladoIPC, 18, tmp->montoAjustado);
}
