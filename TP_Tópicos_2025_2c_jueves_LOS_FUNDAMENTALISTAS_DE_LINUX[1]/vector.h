...
#define MAX_CAPACIDAD 100000000 /** @brief 100MB, solo para crear con capacidad dada */

#define TAM_LINEA_BUFFER 500
...
int vectorLeerDeTexto(Vector_t* vector, const char* nomArch, int (*ParsearTxt)(char*, void*));
